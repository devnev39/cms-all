...
import { createOrder, verifyPayment } from "../../services/user/order";
...
function Cart() {
  ...
  const checkoutCart = () => {
    ...
    createOrder(
      {
        cartItems: cartType === "fooditems" ? cart : [],
        coupons: cartType === "coupons" ? cart.map((i) => i.item) : [],
        catererId,
        orderType: cartType === "fooditems" ? "Items" : "Coupons",
      },
      token
    )
      .then((resp) => {
